...
const STEPS: { id: VisibleStep; labelKey: string; hintKey: string }[] = [
  {
    ...
    hintKey: "progressChooseFolderDescription",
  },
  {
    id: "review-plan",
    labelKey: "progressReviewMapping",
    hintKey: "progressReviewMappingDescription",
  },
  {
    id: "confirm-copy",
    labelKey: "progressConfirmCopy",
    hintKey: "progressConfirmCopyDescription",
  },
];
...
export function ProgressTracker({ visibleStep, t }: Props) {
  ...
  return (
    <nav
      ...
      className="border-b border-border bg-card/40 px-6 py-4 cursor-default select-none"
    >
